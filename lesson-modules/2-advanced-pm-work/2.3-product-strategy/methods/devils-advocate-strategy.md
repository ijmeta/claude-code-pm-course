...
**Example:**
"FinTrack's activation has improved but we need sustainable growth. Our strategy is to become the AI-native personal finance tool for individuals and households, differentiating through deep bank sync integration and smart categorization that larger competitors can't match. We'll execute this through: (1) AI spending insights for personalized recommendations, (2) AI-powered budget suggestions based on spending patterns, (3) community-led growth to offset limited marketing budget."
...
### Example: FinTrack AI Strategy

**Strategic Bet:** "Build AI spending coach for personal finance"
...
### Example Pre-Mortem: FinTrack AI Strategy

**"It's Q4 2026. Our AI spending coach strategy failed. Here's why:**

The AI spending insights worked technically, but users didn't engage regularly. Turns out people check their finances once a week at most — the AI suggestions felt repetitive and users stopped noticing them.

We also underestimated competitors. Monarch Money shipped a similar feature 3 months after us with better personalization. We couldn't differentiate enough to retain users.

Finally, AI infrastructure costs were 4x our projections. We had to raise prices from $9.99 to $15/month, which killed conversion. Budget-conscious users went with free alternatives like Credit Karma.

The real mistake: we built what sounded impressive in a demo, not what users actually needed day-to-day. AI insights were a solution looking for a problem."
