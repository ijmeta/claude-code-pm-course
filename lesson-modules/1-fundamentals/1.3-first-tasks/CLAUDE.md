...
Up until now, we've covered the basics - what FinTrack is, how to visualize files. But now you're going to do **actual PM work** with Claude Code.
...
You've just completed 8 user interviews for the FinTrack onboarding redesign. Each interview transcript is 3-4 pages of conversation. Your goal: identify common pain points and feature requests.
...
- Overwhelming bank account connection setup
- Unclear budget goal-setting process
- Lack of helpful templates to get started
...
- Recommendation for which patterns would work best for FinTrack
...
- Connect back to FinTrack pain points

**Scenario realism:**
- Make FinTrack feel real (mention Maya the CEO, etc.)
