...
# User Research Report: FinTrack Onboarding Study
...
We conducted 8 user interviews (Oct 2-6) with new FinTrack users to understand onboarding friction points. Participants were recruited from recent trial signups and represented a mix of roles (PMs, engineers, marketers) and team sizes (solo to 50+ people).
