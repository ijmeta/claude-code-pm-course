...
- Position --dangerously-skip-permissions as a workflow accelerator (Joni's strong recommendation)
...
**Scenario:** One of FinTrack's competitors just launched a 'Chat with your finances AI' feature this morning. Your exec team is panicking in Slack asking how we should respond.
...
- Create `competitive-threat-plan.md` with structured plan breaking down the work:
  - Step 1: Research FinTrack's main competitors
...
This is an advanced flag that skips all permission prompts. Joni (the course creator) highly recommends using it for speed.
...
- The rainbow comment about ultrathink is Joni's personality coming through
