...
**Scenario:** It's Monday morning. You had a busy week last week - 10 different meetings about various FinTrack features, customer feedback sessions, and sprint planning. Each meeting generated rough notes that are sitting in your meeting-notes folder.
...
**Scenario:** FinTrack's CEO Maya just asked you for a competitive landscape update. She wants to know:
...
3. Each agent should create a competitor file (competitor-ynab.md, competitor-monarch.md, etc.) with:
   - Features
   - Pricing
   - Positioning
   - Strengths/weaknesses
   - Opportunities for FinTrack
...
Based on FinTrack's personal finance space, the top 5 competitors are:
1. YNAB (You Need a Budget - category leader, strong methodology)
2. Monarch Money (modern, fast-growing, Mint replacement)
3. Copilot (Apple-first, design-focused, loyal fanbase)
4. Empower (formerly Personal Capital, wealth-focused)
5. Credit Karma (free, credit-focused, massive user base)

**Step 2: Launching 5 agents for parallel research**

Agent 1: Researching YNAB via web search
Agent 2: Researching Monarch Money via web search
Agent 3: Researching Copilot via web search
Agent 4: Researching Empower via web search
Agent 5: Researching Credit Karma via web search
...
- competitor-ynab.md
- competitor-monarch.md
- competitor-copilot.md
- competitor-empower.md
- competitor-creditkarma.md
...
**Key Opportunities for FinTrack:**
...
**Scenario:** You need to make a decision about building a dedicated mobile app for FinTrack. You have lots of different data sources that require different approaches:
...
- Calculates percentages requesting mobile app
- Segments by user type (young professional, family, debt payoff)
